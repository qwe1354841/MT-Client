local  this_file = "SMovie_838.lua:"
-- @@runlua SMovie_838
SMovie_838 = {}
...
--例如第一幕进战斗前： SMovie_838    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_838

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_838",
	LeadingActor = {
				},
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "成功了！妖怪！快来受死！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
