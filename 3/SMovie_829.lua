local  this_file = "SMovie_829.lua:"
-- @@runlua SMovie_829
SMovie_829 = {}
...
--例如第一幕进战斗前： SMovie_829    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_829

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_829",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30228, name = "斗战胜佛", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 131, posy = 24, dir = 3},
			},		
		npc3 = {Basic = {id = 30229, name = "花果山大弟子", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 145, posy = 32, dir = 4},
			},		
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "你们来了，俺老孙等你们好久了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "斗战胜佛，这次我们来是想和你了解一下——————", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "别喊俺斗战胜佛，喊俺齐天大圣。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "你别说这成佛了之后还真够无聊的，要不你先和俺的大弟子切磋一下，让俺乐呵乐呵？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc3", Content = "师父，没你这么使唤人的，要是输了我这大弟子的脸往哪搁啊？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "呸呸呸，俺老孙都不怕，你怕啥？那边那个新来的，打赢了俺这大弟子，咱们再来好好谈谈。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "那我可就恭敬不如从命了，大师兄，请赐教！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData8 = {Npc = "npc3", Content = "你说我咋这么命苦呢？得嘞，来吧，我是不会手下留情的！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
