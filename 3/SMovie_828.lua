local  this_file = "SMovie_828.lua:"
-- @@runlua SMovie_828
SMovie_828 = {}
...
--例如第一幕进战斗前： SMovie_828    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_828

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_828",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30344, name = "圣灵残魂", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 52, posy = 178, dir = 7},
			},		
		npc3 = {Basic = {id = 30345, name = "发灵", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 42, posy = 173, dir = 3},
			},		
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "终于，这个生生轮回的梦可以结束了，主人，你也可以安息了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "快离开梦境吧！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
