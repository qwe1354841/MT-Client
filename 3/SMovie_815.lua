local  this_file = "SMovie_815.lua:"
-- @@runlua SMovie_815
SMovie_815 = {}
...
--例如第一幕进战斗前： SMovie_815    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_815

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_815",
	LeadingActor = {
				},
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "呼，这个妖怪还挺厉害的啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "不能再耽搁了，赶紧去山顶找青年的妻子！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
