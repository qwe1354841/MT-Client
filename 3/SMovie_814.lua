local  this_file = "SMovie_814.lua:"
-- @@runlua SMovie_814
SMovie_814 = {}
...
--例如第一幕进战斗前： SMovie_814    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_814

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_814",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30248, name = "地府鬼将", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 120, posy = 102, dir = 3},
			},	
		npc3 = {Basic = {id = 30249, name = "地府鬼将", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 115, posy = 108, dir = 3},
			},	
		npc4 = {Basic = {id = 30240, name = "捣乱的鬼魂", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 134, posy = 109, dir = 7},
			},	
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "呼，每次传送总是搞得的头疼。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "这里应该就是地府了吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "什么情况，怎么这么吵......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "你这鬼魂，速速投降！不然我就对你不客气了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc4", Content = "切，我倒要看看你能拿我怎么办。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "那边那个人类，你是来地府看热闹的吗！还不快来帮忙！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "额，我就想安安静静的做个美兰子，怎么就这么难呢？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
