local  this_file = "SMovie_822.lua:"
-- @@runlua SMovie_822
SMovie_822 = {}
...
--例如第一幕进战斗前： SMovie_822    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_822

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_822",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30214, name = "哨兵", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},		
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "咳，不能让你过去！不能让你打扰老大的好事！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "嘿嘿嘿，就算你打败我也没用，我刚才已经把信号发出去了！很快就会有大批的兄弟过来！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "糟了，他肯定是发信号了。看来从这边过去是不可能了。得想个法子。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "没用的！两个口子都被我们的兄弟看守着，等会他们就会过来支援我了，你休想打扰我们老大的好事！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "两个口子？如果是这样的话！赶紧去另一边看看或许还有机会！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
