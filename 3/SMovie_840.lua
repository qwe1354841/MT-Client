local  this_file = "SMovie_840.lua:"
-- @@runlua SMovie_840
SMovie_840 = {}
...
--例如第一幕进战斗前： SMovie_840    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_840

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_840",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30357, name = "？？？", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 96, posy = 59, dir = 4},
			},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "呼，好难对付的家伙，竟然拥有五行的能力。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "我已臻消散，但封印既解，我也算完成了任务。少侠，今后的天下苍生，可要守护好啊哈哈哈哈……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "这家伙都要魂飞魄散了还在疯言疯语，快离开洞窟，大圣他们还在等我们的捷报呢。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
