local  this_file = "SMovie_804.lua:"
-- @@runlua SMovie_804
SMovie_804 = {}
...
--例如第一幕进战斗前： SMovie_804    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_804

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_804",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30216, name = "大当家", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},		
	}
