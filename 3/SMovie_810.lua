local  this_file = "SMovie_810.lua:"
-- @@runlua SMovie_810
SMovie_810 = {}
...
--例如第一幕进战斗前： SMovie_810    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_810

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_810",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30230, name = "鬼鬼祟祟的猴子", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 159, posy = 68, dir = 0},
			},	
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "少侠饶命啊我下次再也不敢了。我不就偷吃了几个蟠桃吗，不至于这么狠吧！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "偷吃，蟠桃？？？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "囧", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "我以为你是大圣爷说的那些个魔物...骚瑞啦。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "你才魔物，你全家都是魔物。你见过这么帅气的魔物吗！哼。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "骚瑞骚瑞，那你最近有见过什么奇怪的人吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc2", Content = "你这么一说我还真想起一件事来！我们家老大之前总觉得有人在西北面的山崖上盯着他。你可以去那里看看！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData8 = {Npc = "npc1", Content = "谢啦，我这就去瞅瞅！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
