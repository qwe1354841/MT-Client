local  this_file = "SMovie_833.lua:"
-- @@runlua SMovie_833
SMovie_833 = {}
...
--例如第一幕进战斗前： SMovie_833    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_833

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_833",
	LeadingActor = {
				},
...
Action配置为NPC进阶配置
	每个配置的命名为Action + 依次的数字，不可跳数字
		...
		local p_dir = 0
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = p_posx, posy = p_posy, dir = p_dir},
			},
		npc2 = {Basic = {id = 30236, name = "魔物", Occtime = 0.1, OccFrame = 1, Exttime = 0.5, ExitFrame = 3, posx = 96, posy = 59, dir = 4},
			},	
		npc3 = {Basic = {id = 30357, name = "？？？", Occtime = 0.5, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 999, posy = 999, dir = 4},
			},
		npc4 = {Basic = {id = 30357, name = "？？？", Occtime = 0.5, OccFrame = 5, Exttime = 5, ExitFrame = 9, posx = 96, posy = 59, dir = 4},
			},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "不！我才刚刚重见天日！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "这可由不得你了！快去见阎王吧！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "这封印……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "少侠我会替天行道的。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc3", Content = "呵呵呵，少侠还真是个有趣的灵魂。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc1", Content = "什么人！你不是刚刚那个魔物。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc4", Content = "那种低等生命岂能与我相同，我可是。。。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "我感应到了，他就在这个封印中，快把这个封印解除，无论多少魔物，今天，我都要铲除！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc4", Content = "不！不要解开这个封印！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "看我的！破！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
