local  this_file = "SMovie_824.lua:"
-- @@runlua SMovie_824
SMovie_824 = {}
...
--例如第一幕进战斗前： SMovie_824    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_824

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_824",
	LeadingActor = {
				},
...
--		npc2 = {Basic = {id = 30213, name = "哨兵", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
--			},			
		npc2 = {Basic = {id = 30334, name = "圣灵残魂", Occtime = 0.1, OccFrame = 1, Exttime = 1, ExitFrame = 9, posx = 999, posy = 999, dir = 1},
			},	
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "呃，头好晕，身体好热，魂魄感觉要裂开了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "快稳住魂灵，汝刚刚魂魄归体，身体非常虚弱，吾等先离开这里，恢复好后再谈取经之计", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
