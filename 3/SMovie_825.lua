local  this_file = "SMovie_825.lua:"
-- @@runlua SMovie_825
SMovie_825 = {}
...
--例如第一幕进战斗前： SMovie_825    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_825

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_825",
	LeadingActor = {
				},
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "这安魂液可真难喝，而且喝了怎么头这么疼...好难受", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "哇，这是人类吗！让我想想，应该有好几千年没见过人类了呢~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "这是哪里？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "我不告诉你~除非你陪我练练手~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
