local  this_file = "SMovie_728.lua:"
-- @@runlua SMovie_728
SMovie_728 = {}
...
--例如第一幕进战斗前： SMovie_728    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_728

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_728",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2244, name = "水帘洞窟小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},				
		npc3 = {Basic = {id = 2252, name = "洞窟魔王", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 0, posy = 0, dir = 0},
			},				
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "最怕空气突然安静，话说这一层怎么这么安静。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "少侠，我们又见面了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "你不是花果山的混世魔王吗？我没招惹过你吧！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc3", Content = "大圣爷和云游道士让我好好的调教一下你！我会在洞窟的中央等你！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc3", Content = "不过首先，你得打败我的手下们！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "想要挑战魔王大人！就先打败我们！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
