local  this_file = "SMovie_832.lua:"
-- @@runlua SMovie_832
SMovie_832 = {}
...
--例如第一幕进战斗前： SMovie_832    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_832

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_832",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30228, name = "斗战胜佛", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 0, posy = 0, dir = 0},
			},	
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "少侠，俺花果山的山腰处有一块石碑，刻着水帘洞三个大字。俺在这等你。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "我去，还真把我当跑腿的了？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "哎，师名难违，赶紧去看看吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
