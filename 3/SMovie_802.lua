local  this_file = "SMovie_802.lua:"
-- @@runlua SMovie_802
SMovie_802 = {}
...
--例如第一幕进战斗前： SMovie_802    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_802

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_802",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30209, name = "共工残魂", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},		
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "好强啊，怎么感觉根本打不过！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "呵呵，是不是感觉很绝望？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "以你这凡人之躯，能够抵挡我的神力已经很让我刮目相看了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "然而这些努力都是徒劳的，有些结局是注定了的！就算你再努力也无法改变。就好像当初我再怎么努力也救不回澜儿一样......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "不一样！至少我们愿意去拼去搏！而你只能在这自己制造的梦境里缅怀过去！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "虽然只是梦境，虽然你们醒来后就会忘记这里！但是无论你们说什么，结局都不曾改变！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc2", Content = "现在，滚出我的世界！！！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
