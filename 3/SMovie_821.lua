local  this_file = "SMovie_821.lua:"
-- @@runlua SMovie_821
SMovie_821 = {}
...
--例如第一幕进战斗前： SMovie_821    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_821

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_821",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30212, name = "山贼小头领", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},		
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "该死的，这些个小鬼还挺厉害的嘛。这么周密的计划为什么会被他们发现！？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "若要人不知，除非己莫为！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "哼哼，你以为击败我们就行了吗？实话告诉你，我们老大早就猜到了我们之中会有奸细，早就改了行动时间！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "那你们！！！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "哈哈哈，我们只是诱饵，没准我们老大早就得手了！哈哈哈哈！好了我的任务完成了，就不陪你玩了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "你们这群该死的强盗！！！我和你们没完！时间紧迫赶紧回村里看看！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
