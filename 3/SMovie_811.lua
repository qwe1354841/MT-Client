local  this_file = "SMovie_811.lua:"
-- @@runlua SMovie_811
SMovie_811 = {}
...
--例如第一幕进战斗前： SMovie_811    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_811

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_811",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30231, name = "混世魔王", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 58, posy = 60, dir = 5},
			},	
		npc3 = {Basic = {id = 30228, name = "斗战胜佛", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 0, posy = 0, dir = 0},
			},	
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "哈哈哈，没想到少侠也是个性情中人，真是让俺看到了当年的自己", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "这声音是，大圣爷？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc3", Content = "是俺，俺现在用的是秘法传音同你交流。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc3", Content = "少侠你听俺说，这混世魔王是俺机缘巧合下降服而来的，并不是那啥子魔物。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "哦......看他那长相，我还以为。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc3", Content = "哈哈哈，这也是他命中注定有这一劫。既然少侠来到了北山，替俺向公主问声好吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "公主？啧啧啧，有猫腻。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
