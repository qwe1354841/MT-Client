local  this_file = "SMovie_841.lua:"
-- @@runlua SMovie_841
SMovie_841 = {}
...
--例如第一幕进战斗前： SMovie_841    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_841

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_841",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30247, name = "青年妻子", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 196, posy = 52, dir = 4},
			},
		npc3 = {Basic = {id = 30253, name = "黑无常", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 196, posy = 63, dir = 1},
			},
		npc4 = {Basic = {id = 30254, name = "白无常", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 188, posy = 58, dir = 1},
			},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "成功了！女妖的魂魄被你们杀死了，先带着这对夫妻下山找一处安静之地，按照秘法将女子身上阳气慢慢渡给书生，不出三月，应该就能完全康复了，只是…", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "嗯？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "少侠莫问了，之前女妖附身时我就知道会有什么结果了，能多侍奉相公一天，我也足矣。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "唉，世道险恶，何时才能真正国泰民安。先送这对苦命鸳鸯下山吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
