local  this_file = "SMovie_725.lua:"
-- @@runlua SMovie_725
SMovie_725 = {}
...
--例如第一幕进战斗前： SMovie_725    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_725

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_725",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2217, name = "沙城遗址小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},		
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "又是沙城遗址，我估摸着下一层应该是要去水帘洞窟了吧！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "哟，这里还有个妖怪。按照之前的情况，你应该是担心我把你吃了吧？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "你！你怎么知道！你果然就是那个吃妖怪的人类！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "我还知道如果不是你腿脚不好你早跑了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "你！你怎么什么都知道！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "那你站着别动啊，我来吃你了，嘿嘿嘿！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
