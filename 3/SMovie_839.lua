local  this_file = "SMovie_839.lua:"
-- @@runlua SMovie_839
SMovie_839 = {}
...
--例如第一幕进战斗前： SMovie_839    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_839

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_839",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc5 = {Basic = {id = 30357, name = "？？？", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 96, posy = 59, dir = 4},
			},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "有些不对劲！快！强行破开封印！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
