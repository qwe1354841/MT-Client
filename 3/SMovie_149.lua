local  this_file = "SMovie_149.lua:"
-- @@runlua SMovie_149
SMovie_149 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_149全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_149    ， 第一幕战斗后动画： SMovie_149，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_103

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_149",
	--LeadingActor = "npc7",
	--LeadingActor = {
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 10480, name = "王母娘娘·恶", Occtime = 1, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 112, posy = 28, dir = 4},
			},  
		npc3 = {Basic = {id = 0, name = "player", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 122, posy = 29, dir = 6},
			},
		npc4 = {Basic = {id = 10475, name = "邪气", Occtime = 0, OccFrame = 3, Exttime = 0.5, ExitFrame = 5, Dye = 0, posx = 132, posy = 28, dir = 6},
			},	
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "你为何要如此对我，你我本就是一体。只要我统一三界，你就是三界之主了，不再受制于玉帝。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc1", Content = "胡说，我和你不一样。你只是为了你自己私欲，而且玉帝并未限制于我。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData3 = {Npc = "npc2", Content = "哈哈哈，你太天真啦!你的权力都是玉帝给的。只要他一句话，就可以全部收回去。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData4 = {Npc = "npc1", Content = "（其实我根本不求什么权力.......）一派胡言，死到临头还想妖言惑众。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc4", Content = "哼哼，三界迟早是我们的，你们这些三界生灵还是早点投降吧！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "你是...那团邪气！你居然已经炼出了实象！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc4", Content = "嘿嘿嘿，如果把你们都吃了，这方天地还有谁能拦我！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc3", Content = "放肆！！！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
	},
