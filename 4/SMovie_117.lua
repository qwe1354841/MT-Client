local  this_file = "SMovie_117.lua:"
-- @@runlua SMovie_117
SMovie_117 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_117全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_117    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_117

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_117",
	LeadingActor = {
				},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 144, posy = 109, dir = 4},
			},   
		npc2 = {Basic = {id = 10443, name = "丹炉之灵", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = -1, posy = -1, dir = 4},
			},   			
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "这里就是丹炉地宫的内炉了么？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc1", Content = "阴森，寒冷，幽静，空气中没有丝毫生者的气息。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData3 = {Npc = "npc1", Content = "大圣说的果然没错，内炉不是个好玩的地方，还是快些下去找姑娘吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData4 = {Npc = "npc2", Content = "既然进来了，就快下来见我吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData5 = {Npc = "npc1", Content = "这个声音……你是？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData6 = {Npc = "npc2", Content = "我就是这整个丹炉的器灵，你可以称呼我丹炉之灵，来吧，你想知道的问题，都可以得到解答。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
