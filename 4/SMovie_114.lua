local  this_file = "SMovie_114.lua:"
-- @@runlua SMovie_114
SMovie_114 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_114全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_114    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_114

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_114",
	LeadingActor = {
				},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 147, posy = 104, dir = 7},
			},   
		npc2 = {Basic = {id = 10423, name = "孙悟空", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 138, posy = 98, dir = 3},
			},   			
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "哈哈哈，真有趣，原来后来发生了这样的事情，不过有一点不对，我怎么可能输给什么如来？佛都是天天讲经打坐的，打架不可能是俺老孙的对手。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc1", Content = "具体我也不知道了啊，都是祖祖辈辈传下来的，可能其中有些史实被遗忘篡改了吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData3 = {Npc = "npc2", Content = "一定是这样，不过撒尿这个我喜欢，如果出去之后遇到了如来，我肯定照做，哈哈哈哈。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData4 = {Npc = "npc1", Content = "大圣真性情，哎，这里就是第三层了，断桥中间的那个应该就是四层入口了吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData5 = {Npc = "npc2", Content = "是啊，不知道为什么好好的断了两只桥，太上老头连自家后院都不知道修缮的。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData6 = {Npc = "npc1", Content = "嗯？那边炼魔大阵好像有骚动，去看看！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData7 = {Npc = "npc2", Content = "哈哈，俺老孙去也！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData8 = {Npc = "npc1", Content = "慢点大圣！等等我啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
