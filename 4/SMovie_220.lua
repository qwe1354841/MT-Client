local  this_file = "SMovie_220.lua:"
-- @@runlua SMovie_220
SMovie_220 = {}
...
--例如第一幕进战斗前： SMovie_220    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_220

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_220",
	LeadingActor = {
		Frame1 = {{0.2,"npc3"}},
		Frame5 = {{0.5,"npc1"}},
		Frame9 = {{0.5,"npc3"}},
	...
	FrameTable = {
		...
		Frame9 = {FrameType = "自由运动", FrameTime = 1.5},
		Frame10 = {FrameType = "压边对话", FrameTalk = "TalkList5"},	
...
local NpcTable = {
	npc1 = {Basic = {id = 22075, name = "烟云客", Occtime = 0.1, OccFrame = 1, Exttime = 99, ExitFrame = 9, posx = 50, posy = 225, dir = 7},
		Frame7 = {
					Action1 = { ActionTime = 0.5, ActType = "转身", ActData = {3}},
					Action2 = { ActionTime = 1, ActType = "移动", ActData = {75,238}},
			},
		},
	npc2 = {Basic = {id = 20039, name = "国子监祭酒", Occtime = 0.1, OccFrame = 1, Exttime = 99, ExitFrame = 9, posx = 42, posy = 217, dir = 3},
		},		
	npc3 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 99, ExitFrame = 9, posx = 125, posy = 265, dir = 4},
		Frame3 = {
					Action1 = { ActionTime = 0.5, ActType = "转身", ActData = {7}},
			},
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "诶，人生真是寂寞如雪啊，难道就没有什么有趣的事情嘛。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc3", Content = "咦，那不是烟云客么。嘿，看我去逗逗他！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc2", Content = "哎哟，我说，那铲奸除恶的事情，就交给官府去办嘛，你一个读书人，是不是？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "整体打打杀杀的，我不是说你不成体统啊，我是担心你万一伤着哪了，圣上罪责起来，你该如何招架，是不是？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "老师，我知道了。我就是随手治治那些小流氓们，不会出啥茬子的。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "那可不能这么说，你想想，你的人生值多少金银珠宝，那些小流氓值多少，把时间花在小流氓上多不值呀，是不是？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "知道啦知道啦，是是是！我出去晃悠晃悠了，告辞啦。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList4 = {
		TalkData1 = {Npc = "npc1", Content = "老师还是一如既往的啰嗦……算了算了，我去慈恩寺散散心好了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList5 = {
		TalkData1 = {Npc = "npc3", Content = "烟云客好像说是要去慈恩寺吧，跟上去瞧瞧~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
