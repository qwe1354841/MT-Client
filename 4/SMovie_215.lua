local  this_file = "SMovie_215.lua:"
-- @@runlua SMovie_215
SMovie_215 = {}
...
--例如第一幕进战斗前： SMovie_215    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_215

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_215",
	LeadingActor = {
		Frame1 = {{0.2,"npc3"}},
		Frame3 = {{1,"npc1"}},
		Frame5 = {{0.5,"npc3"}},
...
local NpcTable = {
	npc1 = {Basic = {id = 22069, name = "雨师君", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 58, posy = 38, dir = 4},
		},
	npc2 = {Basic = {id = 22093, name = "奇怪的女子", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 49, posy = 37, dir = 2},
		},
	npc3 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 83, posy = 65, dir = 4},
			Frame3 = {
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "雨师君说他在水帘洞窟，这洞窟这么大，也不知道他在哪里。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "咦，那边好像有人。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "咦，这位兄台，你在做什么呀？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "嘿！我说，你在练什么厉害的法术，教教我呗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "看我戳你一下~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "哎哟！疼！好疼……！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc3", Content = "那不是雨师君吗，过去看看。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
...
local ImageTable = {
		--img1 = {id = 1801009130,start = 0.5, s_consume = 1, s_type = 2, s_frame = 5, ext = 3, e_consume = 2, e_type = 3, e_frame = 5, posx = 0,posy = 0},
		--img2 = {id = 1801004999,start = 0.5, s_consume = 3, s_type = 6, s_frame = 5, ext = 3, e_consume = 2, e_type = 3, e_frame = 5, posx = 340,posy = 180},
