local  this_file = "SMovie_716.lua:"
-- @@runlua SMovie_716
SMovie_716 = {}
...
--例如第一幕进战斗前： SMovie_716    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_716

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_716",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2138, name = "观光者", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 0, posy = 0, dir = 0},
			},			
		npc3 = {Basic = {id = 2136, name = "水帘洞窟小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},						
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "你们怎么可以这样，来观光就一定要买纪念品吗！你们这是强买强卖，我要投诉你们！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "强买强卖？还投诉我们？我话就放在这里了，只要有一个不肯买纪念品，你们全都别想去下一层！还观光，没钱你观光个屁嘞！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "我说，这个大哥，你这是不是有点儿过分了啊？不买就算了嘛，你怎么还不让他们去下一层啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc3", Content = "你谁啊你，少管闲事。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc3", Content = "等一下，我好像没见过你啊。你啥时候来的，一个人也不跟团。你买票没？拿出来我看看。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "大哥，你这是掉钱眼里了吗？做人，哦不，做妖也不能这样啊！我们要向前看，向美好的未来看。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc3", Content = "你说的没错，要向钱看！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
