local  this_file = "SMovie_120.lua:"
-- @@runlua SMovie_120
SMovie_120 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_120全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_120    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_120

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_120",
	LeadingActor = {
		Frame3 = {{0.5,"npc2"}},
		Frame5 = {{0.5,"npc1"}},
				},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 99, posy = 98, dir = 0},
			},   
		npc2 = {Basic = {id = 10449, name = "仙人甲", Occtime = 0.1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 73, posy = 74, dir = 5},
			}, 
		npc3 = {Basic = {id = 10450, name = "仙人乙", Occtime = 0.1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 55, posy = 79, dir = 2},
			}, 
		npc4 = {Basic = {id = 10451, name = "仙人丙", Occtime = 0.1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 68, posy = 81, dir = 7},
			},   			
		npc5 = {Basic = {id = 10448, name = "桃灵", Occtime = 0.1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 98, posy = 88, dir = 4},
			},   			
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "唔，让我瞅瞅......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc1", Content = "嗯？那边怎么吵吵闹闹的？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "诶，又到了三千年一次的摇奖大会了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc3", Content = "是啊，也不知道这次谁会中奖。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData3 = {Npc = "npc2", Content = "我们这种小角色就不要瞎想了。不过听说最近来了个新人，挺受玉帝的青睐的啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData4 = {Npc = "npc4", Content = "哎，我们这种小角色以后可怎么办呢。如果这次再分不到蟠桃，下一次的蟠桃大会我能不能熬到都是个未知之数啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc1", Content = "看来这蟠桃大会还暗藏玄机啊。不管了，还是先去找王母娘娘吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
