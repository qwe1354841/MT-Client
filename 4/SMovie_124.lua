local  this_file = "SMovie_124.lua:"
-- @@runlua SMovie_124
SMovie_124 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_124全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_124    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_124

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_124",
	LeadingActor = {
		Frame1 = {{0.1,"npc1"}},
				},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 0, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 71, posy = 22, dir = 4},
			},   
		npc2 = {Basic = {id = 10463, name = "鬼使", Occtime = 0.5, OccFrame = 1, Exttime = 3.2, ExitFrame = 3, posx = 94, posy = 28, dir = 7},	
			}, 
		npc3 = {Basic = {id = 10464, name = "鬼使", Occtime = 0.5, OccFrame = 1, Exttime = 3.2, ExitFrame = 3, posx = 87, posy = 34, dir = 7},
			}, 			
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "是鬼使！不对，他们看起来......容我看看生死簿。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc1", Content = "......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData3 = {Npc = "npc1", Content = "...... ......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData4 = {Npc = "npc1", Content = "果然被污染了，看来免不了一场恶战了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
