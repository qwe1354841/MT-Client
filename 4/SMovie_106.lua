local  this_file = "SMovie_106.lua:"
-- @@runlua SMovie_106
SMovie_106 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_106全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_106    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_106

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_106",
	LeadingActor = "npc1",
	TotalTime = 37,
	...
	FrameTable = {
		...
		Frame3 = {FrameType = "自由运动", FrameTime = 7},
	}
}
...
local NpcTable = {
		npc1 = {Basic = {id = 10124, name = "唐王李世民", Occtime = 1, OccFrame = 1, Exttime = 34, ExitFrame = 3, posx = 108, posy = 73, dir = 3},				
			},  
		npc2 = {Basic = {id = 10096, name = "泾河龙王", Occtime = 1, OccFrame = 1, Exttime = 34, ExitFrame = 3, posx = 113, posy = 77, dir = 7},
			},  
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "陛下，救我！陛下，救我！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc1", Content = "你你你，是人是鬼？？？为什么要朕救你？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "臣是长安城外泾河的龙王，陛下是真龙，臣是业龙，臣因犯下天条，当被陛下贤臣魏征监斩，望陛下救我一救。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "既然是魏征监斩，这个好办，朕可以救你，明天午时，朕拖住魏征便是。你且宽心的去吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "那就多谢陛下大恩了，不过陛下切记此事啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},				
	},
}	
...
local ImageTable = {
		img1 = {id = 1801009010,start = 0, s_consume = 0.5, s_frame = 3, s_type = 2, ext = 6, e_consume = 1, e_type = 3, e_frame = 3, posx = 0,posy = 0,isfullscrean = true},
		img2 = {id = 1801004130,start = 1, s_consume = 1, s_frame = 3, s_type = 6, ext = 5, e_consume = 1, e_type = 3, e_frame = 3, posx = 330,posy = 100},
	}
