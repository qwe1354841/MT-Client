local  this_file = "SMovie_222.lua:"
-- @@runlua SMovie_222
SMovie_222 = {}
...
--例如第一幕进战斗前： SMovie_222    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_222

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_222",
	LeadingActor = {
		Frame1 = {{0.2,"npc3"}},
		Frame3 = {{1,"npc1"}},
		Frame5 = {{1,"npc3"}},
	...
	FrameTable = {
		Frame1 = {FrameType = "自由运动", FrameTime = 2.5},
...
local NpcTable = {
	npc1 = {Basic = {id = 22103, name = "凤凰仙", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 172, posy = 83, dir = 4},
		},
	npc2 = {Basic = {id = 21062, name = "井边的村民", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 154, posy = 60, dir = 4},
		},
	npc3 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 142, posy = 104, dir = 4},
			Frame1 = {					
					Action1 = { ActionTime = 1.5, ActType = "转身", ActData = {1}},
				},
		},		
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "那不是凤凰仙子吗！传闻她正在游历各国，真是让人好生羡慕啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "嗯？她怎么愁眉不展的，是发生了什么事情吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc1", Content = "之前答应了鲛灵妹妹要帮她去找枭魔王的下落，可是这茫茫人海该从哪里找起呢。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "更何况枭魔王已经好久都没有消息了，甚至连他是生是死都不知道……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "只能先从枭魔王的好友中寻找了……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "听说枭魔王曾在傲来村附近隐居过，我先去那附近看看吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc3", Content = "凤凰仙子好像在找人呢，跟上去看看~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
