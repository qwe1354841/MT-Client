local  this_file = "SMovie_715.lua:"
-- @@runlua SMovie_715
SMovie_715 = {}
...
--例如第一幕进战斗前： SMovie_715    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_715

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_715",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2127, name = "水帘洞窟小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},			
		npc3 = {Basic = {id = 2128, name = "观光者", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 0, posy = 0, dir = 0},
			},			
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "就是他们，东西卖的这么贵也就算了，结果还是个次品！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "干什么干什么，你爱买不买，不买拉倒！我们又没求着你买，也没强买强卖。不都是你们自愿的吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc3", Content = "真是气煞我也，顾客是上帝难道你们不知道吗！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "哎呦喂，啥时候开始你们也信上帝了啊？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "那个我来说句公道话。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc3", Content = "你谁啊，谁要你多管闲事了！滚！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc2", Content = "就是就是，你谁啊。我说你怎么进来的，票买了没，意外险买了没？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData8 = {Npc = "npc2", Content = "别废话，赶紧的把门票钱拿来。还有刚才那个谁，退货是不可能的。不要的东西你自己去丢了，别在这里妨碍我收钱。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData9 = {Npc = "npc1", Content = "哎......看来讲道理是行不通了，只能通过其他手段了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
