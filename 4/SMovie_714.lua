local  this_file = "SMovie_714.lua:"
-- @@runlua SMovie_714
SMovie_714 = {}
...
--例如第一幕进战斗前： SMovie_714    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_714

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_714",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2118, name = "沙城遗址小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},			
		npc3 = {Basic = {id = 2126, name = "疯狂的毒蛛", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 0, posy = 0, dir = 0},
			},			
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "就是你这个人类，吃了我的小弟们吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "你看我像那样的人吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc3", Content = "不像。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "对啊对啊，终于碰到个明白事理的妖了！你说我要是把他们都吃了，那我咋还没撑死，对吧！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc3", Content = "为啥没撑死我不知道，但是你不像个吃妖的人。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "说得好！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc3", Content = "你不像，你本来就是。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData8 = {Npc = "npc1", Content = "我......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData9 = {Npc = "npc3", Content = "小的们，给我上！为兄弟们报仇！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData10 = {Npc = "npc2", Content = "杀啊！为兄弟们报仇！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
