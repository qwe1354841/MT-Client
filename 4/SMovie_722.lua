local  this_file = "SMovie_722.lua:"
-- @@runlua SMovie_722
SMovie_722 = {}
...
--例如第一幕进战斗前： SMovie_722    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_722

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_722",
	LeadingActor = {
				},
...
Action配置为NPC进阶配置
	...
	local p_dir = 4
local NpcTable = {
	npc1 = {Basic = {id = 2001, name = "大雁塔小妖", Occtime = 0.1, OccFrame = 1, Exttime = 3.4, ExitFrame = 7, posx = m_posx, posy = m_posy, dir = m_dir},					
		 }, 
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "这里不是大雁塔一层吗，那个老道士是不是框我啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "哇塞，又有缺心眼被那个老道士忽悠进来了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "得了得了，接下来你是不是要嘲笑我骨骼惊奇了？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "吓！你怎么知道！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "你们说来说去就这么几句话，我都听腻了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "作为一个要拯救世界的人，我还有很多事情要做，没啥功夫和你们浪费时间。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "哈，兄弟们，这人类好狂！让他知道我们的厉害！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
