local  this_file = "SMovie_703.lua:"
-- @@runlua SMovie_703
SMovie_703 = {}
...
--例如第一幕进战斗前： SMovie_703    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_703

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_703",
	LeadingActor = {
				},
...
local NpcTable = {
	...
	npc1 = {Basic = {id = 2019, name = "大雁塔小妖", Occtime = 0.1, OccFrame = 1, Exttime = 3.4, ExitFrame = 7, posx = m_posx, posy = m_posy, dir = m_dir},					
		},
	npc2 = {Basic = {id = 2020, name = "大雁塔小妖", Occtime = 0.1, OccFrame = 1, Exttime = 3.4, ExitFrame = 7, posx = 0, posy = 0, dir = 4},					
		},			
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "快来看啊！居然是人类诶！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "是啊是啊！我好久没见过人类了呢！记得上一次看到人类好像是几千年前了吧？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "不过一个人类是不是太少了点，咋们兄弟这么多，清蒸油炸红烧油焖，一个根本不够啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc3", Content = "我说你们胃口真是不错啊，我看起来有这么菜吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "难道不是吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "难道不菜吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "你看起来就是菜啊。老铁，没毛病！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
