local  this_file = "SMovie_702.lua:"
-- @@runlua SMovie_702
SMovie_702 = {}
...
--例如第一幕进战斗前： SMovie_702    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_702

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_702",
	LeadingActor = {
				},
...
local NpcTable = {
	...
	npc1 = {Basic = {id = 2010, name = "大雁塔小妖", Occtime = 0.1, OccFrame = 1, Exttime = 3.4, ExitFrame = 7, posx = m_posx, posy = m_posy, dir = m_dir},					
		},  
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "这次进来的这个人类质量不错啊，至少不像前几个碰几下就挂了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "今天就让本妖来好好来“宠爱”你一下！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "现在的妖怪都这么狂的吗？连小妖都要“宠爱”我了？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "狂？nonono，只是你们太菜了而已。你不知道，高手是如此的寂寞。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = ".......现在的妖怪不光狂，连逼格都这么高的吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "那我倒是要好好的讨教一下！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
