local  this_file = "SMovie_213.lua:"
-- @@runlua SMovie_213
SMovie_213 = {}
...
--例如第一幕进战斗前： SMovie_213    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_213

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_213",
	LeadingActor = {
		Frame1 = {{0.2,"npc3"}},
		Frame3 = {{0.5,"npc1"}},
		Frame5 = {{0.5,"npc3"}},
...
local NpcTable = {
	npc1 = {Basic = {id = 22080, name = "神霄卫", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 170, posy = 49, dir = 1},
		},
	npc2 = {Basic = {id = 10188, name = "哪吒三太子", Occtime = 0.1, OccFrame = 1, Exttime = 0.5, ExitFrame = 9, posx = 177, posy = 41, dir = 5},
		},
	npc3 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 0.5, ExitFrame = 9, posx = 99, posy = 57, dir = 4},
		},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "听说最近这傲来村会有仙人下凡啊", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "我可得去凑个热闹，万一能有啥好事呢！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "神霄卫，你可还记得我？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "你是……我记起来了，你是哪吒三太子！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "很好，关于天庭的事情，你还记得吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "容我想想……好像是之前三届动荡，玉帝派我下凡斩妖除魔，后来的事情我就记不太清了……直到我从傲来村醒来，才慢慢有些记忆。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "不错，这正是我来找你的目的。你在下凡的过程中受到了损伤，因而失去了部分记忆——也就是你原本下凡要执行的任务。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "是的，我记不太清了。明明我记得要去长安干点什么的，就是记不起来要找谁了……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc2", Content = "长安城里有一位叫王灵官的地仙，你找到他，便知道下一步的行动了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData8 = {Npc = "npc1", Content = "好，多谢三太子指点，我这便起身前往长安！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc3", Content = "那个傻大个就是仙人吗……真是看不出来。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "不管了，刚才他是说要去长安城吧，先跟上去看看，和仙人搞好关系总没错的！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
