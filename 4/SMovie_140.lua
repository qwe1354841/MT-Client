local  this_file = "SMovie_140.lua:"
-- @@runlua SMovie_140
SMovie_140 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_140全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_140    ， 第一幕战斗后动画： SMovie_140，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_103

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_140",
		LeadingActor = {
		Frame2 = {{0.1,"npc1"}},
		Frame3 = {{0.1,"npc3"}},
				},
	...
	TotalTime = 20,
	PlotEdge = {onoff = 0, start = 1, s_consume = 2, s_frame = 1,},
...
local NpcTable = {
		npc1 = {Basic = {id = 10480, name = "女子", Occtime = 0, OccFrame = 1, Exttime = 0.5, ExitFrame = 4, Dye = 0, posx = 88, posy = 42, dir = 2},
			},  
		npc2 = {Basic = {id = 60101, name = "老者", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 4, posx = 94, posy = 42, dir = 6},
			},  
		npc3 = {Basic = {id = 0, name = "player", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 58, posy = 32, dir = 2},
			},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "玉帝好像已经有所察觉了，我们要怎么办？",ClickDelay = 5, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc2", Content = "无妨，棋子尚在我们掌控之中，只需静待下一步计划即可。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc1", Content = "既然如此，我先告辞了。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {120,50}},
		TalkData2 = {Npc = "npc2", Content = "........", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {128,51}},		
		TalkData3 = {Npc = "npc3", Content = "哪两个人会是谁呢？看了此事关系重大。先回去以免被发现。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
	},
