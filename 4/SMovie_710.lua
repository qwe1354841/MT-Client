local  this_file = "SMovie_710.lua:"
-- @@runlua SMovie_710
SMovie_710 = {}
...
--例如第一幕进战斗前： SMovie_710    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_710

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_710",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2082, name = "沙城遗址小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},	
		npc3 = {Basic = {id = 2083, name = "沙城遗址小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 0, posy = 0, dir = 0},
			},		
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "呼呼呼，我在这看着，你快去和老大报告！就说地宫来了一个吃妖的人类！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "什么情况？吃妖？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "是的是的，赶紧的了，别愣着，快去！那个人类就快要来了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc3", Content = "啊，好！我这就去！你替我看着这里！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc3", Content = "大家注意了，大家注意了！地宫来了个吃妖怪的人类，来了个吃妖怪的人类！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "什么情况，怎么越传越离谱了！我啥时候吃妖了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "那个乱散布谣言的妖怪你给我站住！别跑！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
