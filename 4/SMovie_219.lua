local  this_file = "SMovie_219.lua:"
-- @@runlua SMovie_219
SMovie_219 = {}
...
--例如第一幕进战斗前： SMovie_219    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_219

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_219",
	LeadingActor = {
		Frame1 = {{0.2,"npc1"}},
		Frame3 = {{0.1,"npc3"}},
		Frame5 = {{0.1,"npc1"}},
...
local NpcTable = {
	npc1 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 81, posy = 182, dir = 5},
		},
	npc2 = {Basic = {id = 21028, name = "银角大王", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 48, posy = 199, dir = 4},
		},
	npc3 = {Basic = {id = 22045, name = "海鲛灵", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 56, posy = 204, dir = 7},
		},	
	npc4 = {Basic = {id = 22101, name = "飞翼姬", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 85, posy = 187, dir = 5},
		},			
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "飞翼姬你看，那是不是海鲛灵？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc4", Content = "好像是鲛灵妹妹。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "小丫头片子是不是活得不耐烦了，敢来打搅你银角爷爷！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "我都听到了，你是个小偷！偷东西还能这么理直气壮，真了不……了不……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc3", Content = "怎么回事，我觉得我头好晕……~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "哈哈，就是为了防止有人来打搅我的好事，我早就埋下了迷魂陷阱。~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "这下你可死到临头了！~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc4", Content = "鲛灵妹妹似乎遇到麻烦了，我们过去看看。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "嗯好。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
