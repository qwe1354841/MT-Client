local  this_file = "SMovie_705.lua:"
-- @@runlua SMovie_705
SMovie_705 = {}
...
--例如第一幕进战斗前： SMovie_705    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_705

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_705",
	LeadingActor = {
				},
...
local NpcTable = {
	...
	npc1 = {Basic = {id = 2045, name = "怒目金刚", Occtime = 0.1, OccFrame = 1, Exttime = 3.4, ExitFrame = 7, posx = 0, posy = 0, dir = 4},					
		},  
	npc2 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = p_posx, posy = p_posy, dir = p_dir},
		},		
	npc3 = {Basic = {id = 2037, name = "大雁塔小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
		},		
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "呼…这破塔还有点高的啊！幸好我没有恐高症......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "你……我好像在哪里见过你。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "哇哦，你见过我吗？不过这也可以理解啊，毕竟人见人爱花见花开车见车爆胎。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "......不是你妈，是你。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "这个笑话可一点也不好笑，好老的梗了。要不我给你讲个比较新的？从前......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "看来是我弄错了，那个人没这么碎嘴。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc2", Content = "什么嘛，我还以为你是来找我叙旧的说。你这妖真没劲。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData8 = {Npc = "npc1", Content = "既然来了，就手底下见真章吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
