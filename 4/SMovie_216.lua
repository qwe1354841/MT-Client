local  this_file = "SMovie_216.lua:"
-- @@runlua SMovie_216
SMovie_216 = {}
...
--例如第一幕进战斗前： SMovie_216    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_216

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_216",
	LeadingActor = {
		Frame1 = {{0.2,"npc1"}},
		Frame3 = {{0.5,"npc2"}},
				},
...
local NpcTable = {
	npc1 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 13, posy = 65, dir = 0},
		},
	npc2 = {Basic = {id = 22045, name = "海鲛灵", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 44, posy = 47, dir = 4},
			Frame5 = {
					Action1 = { ActionTime = 0.5, ActType = "转身", ActData = {5}},
					Action2 = { ActionTime = 1, ActType = "移动", ActData = {19,62}},
					Action3 = { ActionTime = 4.5, ActType = "转身", ActData = {6}},
				},	
		},
	npc3 = {Basic = {id = 22098, name = "懊恼的百姓", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 14, posy = 59, dir = 4},
		},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "这位大哥，你看起来愁眉不展的，是有啥麻烦吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "哎呀，我是之前从长安来这边求雨的百姓，我……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "什么情况，吓死我了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},		
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "哈，我总算从大海里逃出来了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "整天在海面，我都无聊死了。还是表哥好，随随便便就能出来玩。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "咦，前面有个平民似乎很烦恼的样子，我去看看能不能帮到他。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},		
	},
}
