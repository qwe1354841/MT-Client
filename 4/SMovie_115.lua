local  this_file = "SMovie_115.lua:"
-- @@runlua SMovie_115
SMovie_115 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_115全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_115    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_115

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_115",
	LeadingActor = {
				},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 31, posy = 49, dir = 4},
			},   
		npc2 = {Basic = {id = 10432, name = "遣魂使", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 40, posy = 51, dir = 6},
			},   			
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "好厉害，一眨眼就到解阳山了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc1", Content = "按照姑娘所说，那书生应该住在西梁女国境内。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData3 = {Npc = "npc1", Content = "先往那里探查吧！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData4 = {Npc = "npc2", Content = "站住！孤魂野鬼！速速招降！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData5 = {Npc = "npc1", Content = "哎呦，原来说危险是这个原因啊！遣魂使大哥，不是你想的那样！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData6 = {Npc = "npc2", Content = "莫要狡辩！速速招来！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData7 = {Npc = "npc1", Content = "（看来他好像听不大进去）我真的不是孤魂野鬼啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
