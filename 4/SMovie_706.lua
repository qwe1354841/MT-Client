local  this_file = "SMovie_706.lua:"
-- @@runlua SMovie_706
SMovie_706 = {}
...
--例如第一幕进战斗前： SMovie_706    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_706

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_706",
	LeadingActor = {
				},
...
local NpcTable = {
	...
	npc1 = {Basic = {id = 2046, name = "大雁塔小妖", Occtime = 0.1, OccFrame = 1, Exttime = 3.4, ExitFrame = 7, posx = m_posx, posy = m_posy, dir = m_dir},					
		},  
	npc2 = {Basic = {id = 2047, name = "大雁塔小妖", Occtime = 0.1, OccFrame = 1, Exttime = 3.4, ExitFrame = 7, posx = 0, posy = 0, dir = 4},					
		},  
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "啊！是你！你别过来！不要打我！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "？？？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "快跑啊，那个人类又回来了！大家快跑啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc3", Content = "？？？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc3", Content = "什么情况啊，我有这么可怕吗？我又不吃妖怪，况且你们看起来也不好吃。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "别打我啊，少侠饶命，自从上次之后我吃素很久了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc3", Content = "？？？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData8 = {Npc = "npc1", Content = "......奇怪，好像和上次那个人不太一样啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData9 = {Npc = "npc2", Content = "是啊是啊，虽说长的一模一样，但是气场完全不一样啊。这个人看起来好弱啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData10 = {Npc = "npc1", Content = "那我们还愣着干吗，一起上啊！干掉他！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData11 = {Npc = "npc2", Content = "对！干掉他！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
