local  this_file = "SMovie_147.lua:"
-- @@runlua SMovie_147
SMovie_147 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_147全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_147    ， 第一幕战斗后动画： SMovie_147，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_103

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_147",
	--LeadingActor = "npc7",
	--LeadingActor = {
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 10480, name = "王母娘娘·恶", Occtime = 1, OccFrame = 3, Exttime = 1, ExitFrame = 5, posx = 112, posy = 28, dir = 4},
			},  
		npc3 = {Basic = {id = 0, name = "player", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 122, posy = 29, dir = 1},
					Frame3 = {
					Action1 = { ActionTime = 1.5, ActType = "转身", ActData = {7}},
					},
			},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "娘娘，我已准备完毕。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc1", Content = "好，少侠可要小心了！", NpcAction = {AVATARACTION_MAGIC_W1,2}, NpcPop = "", NpcMove = {-1,-1}}, 
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "哈哈哈，现在已经没有人能够阻止我了！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc3", Content = "我是不会让你危害三界的！", NpcAction = {}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData3 = {Npc = "npc2", Content = "就凭你？区区下仙竟有如此魄力，不如投靠与我。待我一统三界便封你为天王。如何？", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData4 = {Npc = "npc3", Content = "娘娘的好意，在下心领了。但为了三界众生，恕我不能答应", NpcAction = {}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData5 = {Npc = "npc2", Content = "哼，真是勇气可嘉，为了奖赏你的勇气，便让你尝尝钉头七箭的厉害。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
