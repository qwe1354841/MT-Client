local  this_file = "SMovie_713.lua:"
-- @@runlua SMovie_713
SMovie_713 = {}
...
--例如第一幕进战斗前： SMovie_713    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_713

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_713",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2109, name = "沙城遗址小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},			
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "啥都别说了，既然被抓住了我也认命了。就是你下口轻一点，成不？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
