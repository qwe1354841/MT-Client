local  this_file = "SMovie_719.lua:"
-- @@runlua SMovie_719
SMovie_719 = {}
...
--例如第一幕进战斗前： SMovie_719    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_719

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_719",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2163, name = "水帘洞窟小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},							
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "刚才那个是什么情况！！！这水帘洞窟怎么会出现这种妖怪！！！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "我听师父说起过，这种妖怪不是只有那个地方才有的吗！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "越想越不对劲，等出去了我得和师父报告一下！这水帘洞窟里必然有玄机！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "哎呦！你走路不长眼睛啊！疼死我了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "对不起，对不起。不好意思，我刚才想事情走神了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "你撞疼我了！这还是其次！我可是在思考天大的事情，结果被你打断了！不行，你得赔！一千，不对一万元宝！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "你这种贪得无厌的妖精，就是欠收拾！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
