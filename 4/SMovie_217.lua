local  this_file = "SMovie_217.lua:"
-- @@runlua SMovie_217
SMovie_217 = {}
...
--例如第一幕进战斗前： SMovie_217    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_217

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_217",
	LeadingActor = {
		Frame1 = {{0.2,"npc3"}},
		Frame3 = {{0.5,"npc1"}},
		Frame5 = {{4.5,"npc3"}},
...
local NpcTable = {
	npc1 = {Basic = {id = 22045, name = "海鲛灵", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 77, posy = 184, dir = 4},
		Frame5 = {
					Action1 = { ActionTime = 0.5, ActType = "转身", ActData = {5}},
					Action2 = { ActionTime = 1, ActType = "移动", ActData = {56,204}},
					Action3 = { ActionTime = 6, ActType = "转身", ActData = {7}},
				},	
		},
	npc2 = {Basic = {id = 21028, name = "银角大王", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 48, posy = 199, dir = 4},
		},
	npc3 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 116, posy = 191, dir = 4},
		},	
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "海鲛灵那个家伙去哪里，真是的，别又闯祸了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "嗯，那边好像有动静", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc1", Content = "真是奇了怪了，找遍整个长安，也没有找到半点表哥的消息。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "算了不管了，既然出来了，我就在这里好好玩玩吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "这个人鬼鬼祟祟的，让我去看看他在干嘛~", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc3", Content = "应该是那边，赶紧过去看看。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
