local  this_file = "SMovie_211.lua:"
-- @@runlua SMovie_211
SMovie_211 = {}
...
--例如第一幕进战斗前： SMovie_211    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_211

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_211",
	LeadingActor = {
	Frame3 = {{0.1,"npc3"}},
				},
...
local NpcTable = {
	npc1 = {Basic = {id = 22004, name = "冥河使", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 614, posy = 174, dir = 3},
		},
	npc2 = {Basic = {id = 22079, name = "傲红莲", Occtime = 0.1, OccFrame = 1, Exttime = 0.5, ExitFrame = 9, posx = 620, posy = 178, dir = 7},
		},
	npc3 = {Basic = {id = 22004, name = "冥河使", Occtime = 0.1, OccFrame = 1, Exttime = 0.5, ExitFrame = 9, posx = 417, posy = 187, dir = 4},
		},	
	npc4 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 0.5, ExitFrame = 9, posx = -1, posy = -1, dir = 4},
		},	
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "哼……真是难缠。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "坏了，这俩小鬼趁我被这姑娘缠身，已经偷偷跑了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "不能因为此人节外生枝，我先遁去！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc4", Content = "哎！冥河兄！别丢下我啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
		TalkData5 = {Npc = "npc2", Content = "嘁，算你跑得快！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc1", Content = "跟丢了这双鬼，真是惭愧，我再去问问袁先生吧……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
