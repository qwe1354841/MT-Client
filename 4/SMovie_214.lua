local  this_file = "SMovie_214.lua:"
-- @@runlua SMovie_214
SMovie_214 = {}
...
--例如第一幕进战斗前： SMovie_214    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_214

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_214",
	LeadingActor = {
		Frame1 = {{0.2,"npc2"}},
		Frame3 = {{0.2,"npc1"}},
	...
	FrameTable = {
		...
		Frame5 = {FrameType = "自由运动", FrameTime = 4.5},
...
local NpcTable = {
	npc1 = {Basic = {id = 22069, name = "雨师君", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 45, posy = 48, dir = 4},
		Frame5 = {
					Action1 = { ActionTime = 0.5, ActType = "转身", ActData = {5}},
					Action2 = { ActionTime = 1, ActType = "移动", ActData = {23,61}},
				},
		},
	npc2 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 19, posy = 63, dir = 7},
		},	
	npc3 = {Basic = {id = 22088, name = "求雨的百姓", Occtime = 0.1, OccFrame = 1, Exttime = 0.1, ExitFrame = 9, posx = 14, posy = 59, dir = 3},
		},	
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "哎，说什么求雨的神仙，这可让我去哪里找啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "求雨？东海的有鳞族不就有这本事吗？哪那需要什么神仙？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc3", Content = "啥？有鳞族，咱老百姓不知道你说的是啥啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "呐，不就是那个嘛，长着角的那个。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc1", Content = "听父亲大人说，又有远方的百姓来我东海海湾求雨，这些百姓真太可怜了……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "对了，父亲还嘱咐我。要我顺便去花果山的水帘洞窟里拜见一下蛟魔王老爷子，让他传我一招半式，会让我受益终生的。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "先不管这些，帮助老百姓要紧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc1", Content = "你便是来求雨的百姓吗？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
