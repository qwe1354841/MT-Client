local  this_file = "SMovie_119.lua:"
-- @@runlua SMovie_119
SMovie_119 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_119全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_119    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_119

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_119",
	LeadingActor = {
				},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 172, posy = 118, dir = 7},
			},   
		npc2 = {Basic = {id = 60093, name = "程咬金", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 164, posy = 113, dir = 3},
			},   			
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "怎么回事？我怎么到了长安城？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc2", Content = "恭喜少侠帮助三藏法师取经归来。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData3 = {Npc = "npc1", Content = "程将军？这……这是什么情况？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData4 = {Npc = "npc2", Content = "少侠可是太兴奋了忘事了？几天前你们取经一行人经历九九八十一难终于取经归来了。现在唐王正要召请你们呢。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData5 = {Npc = "npc1", Content = "啊……啊，是吗？我都不记得了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData6 = {Npc = "npc2", Content = "年轻人嘛，血气方刚容易激动很正常的。哈哈哈，快，唐王已经在传召了，快去吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData7 = {Npc = "npc1", Content = "哎，好嘞！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
