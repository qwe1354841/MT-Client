local  this_file = "SMovie_202.lua:"
-- @@runlua SMovie_202
SMovie_202 = {}
...
--例如第一幕进战斗前： SMovie_202    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_202

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_202",
	LeadingActor = {
		Frame1 = {{0.2,"npc3"}},
		Frame3 = {{0.5,"npc1"}},
		Frame5 = {{4.5,"npc3"}},
...
local NpcTable = {
	npc1 = {Basic = {id = 22110, name = "青丘狐", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 39, posy = 28, dir = 3},
			
			Frame5 = {
					Action1 = { ActionTime = 1, ActType = "移动", ActData = {58,35}},
					Action2 = { ActionTime = 3.5, ActType = "转身", ActData = {1}},
				},
		},
	npc2 = {Basic = {id = 20012, name = "首饰店陆烟儿", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 62, posy = 31, dir = 5},
		},
	npc3 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 81, posy = 48, dir = 4},
			Frame1 = {
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "咦，那个小姐姐好漂亮啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc1", Content = "傲来村，又回来了……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "也不知道他们近况如何……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc1", Content = "现在不是多愁善感的时候！修复界碑才是头等大事！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "听观音菩萨说找的哦啊哦修复宝石可以修复界碑！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "说到珠宝，饰品商人陆烟儿也许知道些什么，赶紧去找她打探一下。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc3", Content = "小姐姐好像需要帮助呢，去看看吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
