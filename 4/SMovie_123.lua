local  this_file = "SMovie_123.lua:"
-- @@runlua SMovie_123
SMovie_123 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_123全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_123    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_123

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_123",
	LeadingActor = {
		Frame1 = {{0.4,"npc1"}},
				},
	...
	FrameTable = {
		Frame1 = {FrameType = "自由运动", FrameTime = 4},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 40, posy = 19, dir = 4},
				Frame1 = {
					Action1 = { ActionTime = 0.5, ActType = "移动", ActData = {71,22}},
				},	
			},   
		npc2 = {Basic = {id = 30299, name = "妖魔", Occtime = 3.5, OccFrame = 1, Exttime = 3.2, ExitFrame = 3, posx = 94, posy = 28, dir = 7},
				
			}, 
		npc3 = {Basic = {id = 30299, name = "妖魔", Occtime = 3.5, OccFrame = 1, Exttime = 3.2, ExitFrame = 3, posx = 87, posy = 34, dir = 7},
				
			}, 
		npc4 = {Basic = {id = 60005, name = "斗战胜佛", Occtime = 0.5, OccFrame = 3, Exttime = 1, ExitFrame = 9, posx = 81, posy = 25, dir = 4},
				Frame3 = {
						Action1 = { ActionTime = 1, ActType = "动作", ActData = { eRoleMovement.MAGIC_W1  ,0}},					
				},
			}, 
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "不好", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
