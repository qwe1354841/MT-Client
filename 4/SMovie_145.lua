local  this_file = "SMovie_145.lua:"
-- @@runlua SMovie_145
SMovie_145 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_145全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_145    ， 第一幕战斗后动画： SMovie_145，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_103

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_145",
	--LeadingActor = "npc7",
	--LeadingActor = {
	...
	FrameTable = {
		Frame1 = {FrameType = "压边对话", FrameTalk = "TalkList1"},
	}
}
...
local NpcTable = {
	npc1 = {Basic = {id = 10478, name = "刑天", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 64, posy = 107, dir = 5}, },
	npc2 = {Basic = {id = 0, name = "player", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 72, posy = 103, dir = 5}, },
}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "没想到居然有点本事，不过到此为止啦。",NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc2", Content = "！！！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
	},
}
