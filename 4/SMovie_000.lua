local  this_file = "SMovie_000.lua:"
-- @@runlua SMovie_000
SMovie_000 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_000全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_000    ， 第一幕战斗后动画： SMovie_000，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_103

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_000",
	--LeadingActor = "npc7",
	--LeadingActor = {
	...
	FrameTable = {
		Frame1 = {FrameType = "自由运动", FrameTime = 5},
		Frame2 = {FrameType = "压边对话", FrameTalk = "TalkList1"},
		Frame3 = {FrameType = "自由运动", FrameTime = 20},
...
local NpcTable = {
		npc1 = {Basic = {id = 30076, name = "斗战神佛", Occtime = 0, OccFrame = 1, Exttime = 0.5, ExitFrame = 5, Dye = 0, posx = 126, posy = 132, dir = 7},
				Frame3 = {
					Action1 = { ActionTime = 8, ActType = "说话", ActData = {"妖怪，看招！"}},
					Action2 = { ActionTime = 8, ActType = "动作", ActData = {4}},
					Action3 = { ActionTime = 5, ActType = "移动", ActData = {119,126}},
					},
			},  
		npc2 = {Basic = {id = 30049, name = "净坛使者", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 135, posy = 132, dir = 7},
			},  
		npc3 = {Basic = {id = 10012, name = "金身罗汉", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 147, posy = 127, dir = 7, hide = true},
			},  
		npc4 = {Basic = {id = 30050, name = "八部天龙", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 153, posy = 119, dir = 7},
			},  
		npc5 = {Basic = {id = 30048, name = "旃檀功德佛", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 136, posy = 124, dir = 7},
				Frame1 = {
					Action1 = { ActionTime = 2, ActType = "动作", ActData = {AVATARACTION_MAGIC_W1}},
				},
				Frame3 = {
					Action1 = { ActionTime = 1, ActType = "说话", ActData = {"共工，现在已经不是你们上古的时代了，你造下无边杀孽，今天我们师徒六人虽然杀不了你，但是一定要用真经的力量封印你。真经，敕！！"}},
					Action2 = { ActionTime = 2, ActType = "动作", ActData = {AVATARACTION_MAGIC_W1}},
					Action3 = { ActionTime = 8, ActType = "转身", ActData = {3}},
				},
			},
		npc6 = {Basic = {id = 60122, name = "共工", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 124, posy = 115, dir = 3},
				Frame3 = {
					Action1 = { ActionTime = 6, ActType = "说话", ActData = {"可恶，我居然会被你们几个人类封印，我不服，我不服啊！！！"}},
					Action2 = { ActionTime = 11, ActType = "说话", ActData = {"（可恶的人类，你们以为封印我就没事了吗？我会没有后手吗？）"}},
					Action3 = { ActionTime = 16, ActType = "说话", ActData = {"（这一缕分魂虽然耗尽了我的最后力量，但一定会实现我的报复计划的，你们给我等着！！）"}},
					Action4 = { ActionTime = 18, ActType = "动作", ActData = {AVATARACTION_MAGIC_W1}},
				},
			},
		npc7 = {Basic = {id = 0, name = "player", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 5, posx = 145, posy = 130, dir = 7},
				Frame3 = {
					Action1 = { Frame = 3, ActionTime = 1, ActType = "动作", ActData = {AVATARACTION_DIE_W2,2}},
					Action2 = { Frame = 3, ActionTime = 1.5, ActType = "动作", ActData = {AVATARACTION_MAGIC_W1,0}},
				},
			},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc7", Content = "来来我们都是水果，果果果果果果",ClickDelay = 5, NpcAction = {AVATARACTION_DIE_W2,2}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc5", Content = "果个锤子", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {132,128}}, 
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc5", Content = "共工，现在已经不是你们上古的时代了，你造下无边杀孽，今天我们五人虽然杀不了你，但是一定要用真经的力量封印你。真经，敕！！", NpcAction = {AVATARACTION_MAGIC_W1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc6", Content = "可恶，我居然会被你们几个人类封印，我不服，我不服啊！！！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData3 = {Npc = "npc6", Content = "（可恶的人类，你们以为封印我就没事了吗？我会没有后手吗？）", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData4 = {Npc = "npc6", Content = "（这一缕分魂虽然耗尽了我的最后力量，但一定会实现我的报复计划的，你们给我等着！！）", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
	},
