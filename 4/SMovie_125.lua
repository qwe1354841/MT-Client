local  this_file = "SMovie_125.lua:"
-- @@runlua SMovie_125
SMovie_125 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_125全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_125    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_125

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_125",
	LeadingActor = {
		Frame1 = {{0.1,"npc1"}},
				},
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "呼呼呼......真是够呛的，怎么这么厉害。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc1", Content = "而且，我感觉他们似乎是被什么控制了！用的那些都不是酆都的招式啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData3 = {Npc = "npc1", Content = "得赶紧上天把这个事情告诉他们。先去找桃灵吧！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
