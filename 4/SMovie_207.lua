local  this_file = "SMovie_207.lua:"
-- @@runlua SMovie_207
SMovie_207 = {}
...
--例如第一幕进战斗前： SMovie_207    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_207

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_207",
	LeadingActor = {
		Frame1 = {{0.2,"npc1"}},
		Frame3 = {{0.5,"npc3"}},
				},
...
local NpcTable = {
	npc1 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 112, posy = 287, dir = 4},
		},
	npc2 = {Basic = {id = 22064, name = "刘夫人", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 121, posy = 262, dir = 3},
		},
	npc3 = {Basic = {id = 22131, name = "花弄影", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 9, posx = 132, posy = 269, dir = 7},
		},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "咦，那不是影姑娘吗。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "哎呀呀，影姑娘的舞姿真是百闻不如一见啊！今天我们家老头子办的宴席，多亏有你来撑场面呢。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = "过奖了刘夫人，刘大官人多次给城里的穷人家捐粮赈灾，我们为大官人做点事情也是应该的。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
