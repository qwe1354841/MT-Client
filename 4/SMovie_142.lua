local  this_file = "SMovie_142.lua:"
-- @@runlua SMovie_142
SMovie_142 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_142全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_142    ， 第一幕战斗后动画： SMovie_142，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_103

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_142",
	--LeadingActor = "npc7",
	--LeadingActor = {
...
local NpcTable = {
		npc1 = {Basic = {id = 10475, name = "妖魔", Occtime = 0, OccFrame = 1, Exttime = 0.5, ExitFrame = 4, Dye = 0, posx = 80, posy = 139, dir = 3},
			},  
		npc2 = {Basic = {id = 0, name = "player", Occtime = 0, OccFrame = 1, Exttime = 1, ExitFrame = 4, posx = 145, posy = 130, dir = 7},
			},
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "我在这里埋伏多时了！不会让你坏了我们的好事得！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData2 = {Npc = "npc2", Content = "大胆妖魔，快速速退去。", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}}, 
	},
}
