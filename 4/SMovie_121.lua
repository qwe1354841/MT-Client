local  this_file = "SMovie_121.lua:"
-- @@runlua SMovie_121
SMovie_121 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_121全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_121    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_121

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_121",
	LeadingActor = {
				},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 32, posy = 42, dir = 7},
				Frame1 = {
					Action1 = { ActionTime = 0.5, ActType = "转身", ActData = {3}},
					Action2 = { ActionTime = 1, ActType = "移动", ActData = {49,56}},
				},
			},   
		npc2 = {Basic = {id = 10453, name = "王母娘娘", Occtime = 0.1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 27, posy = 39, dir = 3},
			}, 
		npc3 = {Basic = {id = 10448, name = "桃灵", Occtime = 4, OccFrame = 1, Exttime = 1, ExitFrame = 3, posx = 56, posy = 60, dir = 7},
			}, 
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc3", Content = "我说，王母娘娘刚才是不是拜托你去调查桃树枯萎的事情了？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData2 = {Npc = "npc1", Content = "你怎么知道，难道你一直在偷听？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
		TalkData3 = {Npc = "npc3", Content = "这你甭管，我在第一次见面的地方等你，你赶紧过来！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc1", Content = "什么情况，怎么一个个都神神叨叨，莫名其妙的。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
