local  this_file = "SMovie_204.lua:"
-- @@runlua SMovie_204
SMovie_204 = {}
...
--例如第一幕进战斗前： SMovie_204    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_204

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_204",
	LeadingActor = {
		Frame1 = {{0.5,"npc1"}},
		Frame3 = {{0.5,"npc2"}},
		Frame5 = {{0.5,"npc1"}},
...
local NpcTable = {
	npc1 = {Basic = {id = 0, name = "player", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 484, posy = 269, dir = 4},
		},
	npc2 = {Basic = {id = 22077, name = "傲红莲", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = 483, posy = 239, dir = 4},
		},	
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "那不是傲红莲吗？她回长安了呀？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "自上次离开长安，已经有三年多了……", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "也不知道我那失踪的弟弟，这些年有没有回过长安。那时候我为了寻他，千辛万苦终于拜入六大门派。一边学习技艺，一边打听他的下落，只可惜事到如今都没有得到过什么音讯。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "从拜入六大门派开始，我都没再回到这里过了。虽然多年不见，但这长安城的一砖一瓦，看起来还是老样子啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc2", Content = "当年我还没离开的时候，这边可不算太平呢。即便是天子脚下，恃强凌弱的事情也比比皆是，不知这么多年后，长安还是不是这种恶俗的风气！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "若再有什么不平之事，我傲红莲，绝不袖手旁观！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
	TalkList3 = {
		TalkData1 = {Npc = "npc1", Content = "好久没见她了，上去和她打个招呼吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
