local  this_file = "SMovie_723.lua:"
-- @@runlua SMovie_723
SMovie_723 = {}
...
--例如第一幕进战斗前： SMovie_723    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_723

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_723",
	LeadingActor = {
				},
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "这里是大雁塔二层啊，我记得那时候在这里碰到了一个螃蟹精。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},		
		TalkData2 = {Npc = "npc1", Content = "这次进来的这个人类质量不错啊，至少不像前几个碰几下就挂了。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
		TalkData3 = {Npc = "npc2", Content = "质量当然不错了，那时候在大雁塔秘境的时候就把你们全打趴下了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
		TalkData4 = {Npc = "npc1", Content = "你这个人类说话有点狂啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
		TalkData5 = {Npc = "npc2", Content = "废话少说，我是来锻炼自己的，不是来和你们扯皮的！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
		TalkData6 = {Npc = "npc1", Content = "吃我大钳子！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},	
	},
}
