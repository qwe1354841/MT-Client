local  this_file = "SMovie_110.lua:"
-- @@runlua SMovie_110
SMovie_110 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_110全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_110    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_110

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_110",
	LeadingActor = {
				},
...
local NpcTable = {
		npc1 = {Basic = {id = 0, name = "player", Occtime = 1, OccFrame = 1, Exttime = 9, ExitFrame = 9, posx = 17, posy = 140, dir = 1},
			},  	
		npc2 = {Basic = {id = 10408, name = "镇守天兵", Occtime = 1, OccFrame = 3, Exttime = 9, ExitFrame = 9, posx = 28, posy = 133, dir = 5},
			},  		
	}
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc1", Content = "这就是天庭了么？确实是仙气满满，但是怎么感觉有一股妖气！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
	TalkList2 = {
		TalkData1 = {Npc = "npc2", Content = "站住！来者何人？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},  
	},
}
