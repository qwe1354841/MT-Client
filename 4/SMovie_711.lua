local  this_file = "SMovie_711.lua:"
-- @@runlua SMovie_711
SMovie_711 = {}
...
--例如第一幕进战斗前： SMovie_711    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_711

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_711",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 2091, name = "沙城遗址小妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},			
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "大家注意啊！都注意了！那个吃妖的人来我们地宫了！听说地宫一层的妖怪已经被他吃完了！他现在第二层大吃特吃，马上就要来我们第三层了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "喂喂喂！你瞎嚷嚷啥呢！什么叫都吃完了！我不过就是吃了几个，啊呸！打了几个妖怪！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "这位大哥，我上有八十老母，下有三岁妖儿，您老人家就发发慈悲高抬贵口，别吃我了吧。我的肉真的不好吃啊！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "我看你们这群妖怪就是欠收拾！皮痒！以讹传讹！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc2", Content = "我，我和你拼了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
