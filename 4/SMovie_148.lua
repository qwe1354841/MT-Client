local  this_file = "SMovie_148.lua:"
-- @@runlua SMovie_148
SMovie_148 = {}


--新建脚本须知：复制本脚本后，使用Ctrl + F 进入查找模式，切换到替换页面
--将SMovie_148全部替换成目标名称
--命名规则     SMovie_  + 第几幕 + 两位数的第几幕的第几个动画
--例如第一幕进战斗前： SMovie_148    ， 第一幕战斗后动画： SMovie_148，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_103

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_148",
	--LeadingActor = "npc7",
	--LeadingActor = {
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "钉头七箭已成。魂飞魄散吧", NpcAction = {eRoleMovement.MAGIC_W1,2}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc3", Content = ".......", NpcAction = {eRoleMovement.DIE_W2,2}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData3 = {Npc = "npc1", Content = "斡旋天地，玄堪造化；以无生有，以死为活。起！",ClickDelay = 5, NpcAction = {eRoleMovement.MAGIC_W1,2}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData4 = {Npc = "npc3", Content = "咦，我没事？！", NpcAction = {eRoleMovement.STAND_W1,2}, NpcPop = "", NpcMove = {-1,-1}}, 
		TalkData5 = {Npc = "npc1", Content = "我是不会让你胡作非为的！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "钉头七箭消耗了她大部分法力，少侠就是现在！", NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
