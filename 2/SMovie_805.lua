local  this_file = "SMovie_805.lua:"
-- @@runlua SMovie_805
SMovie_805 = {}
...
--例如第一幕进战斗前： SMovie_805    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_805

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_805",
	LeadingActor = {
				},
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "切，你这小屁孩还挺厉害！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc2", Content = "但是你以为这样就结束了吗？那你就错了！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "这次我们可是做足了完全的准备！我们是最后一个登岸的队伍！西南面的兄弟早就登录了哈哈哈！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "你说什么！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "你们这群该死的强盗！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc2", Content = "溜了溜了，只要兄弟们成了我这下半辈子也衣食无忧了哈哈哈哈！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData7 = {Npc = "npc1", Content = "赶紧去西南面看看，希望还来得及！", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
	},
}
