local  this_file = "SMovie_801.lua:"
-- @@runlua SMovie_801
SMovie_801 = {}
...
--例如第一幕进战斗前： SMovie_801    ， 第一幕战斗后动画： SMovie_102，第一幕到傲来村（因为切换场景需要新的脚本）动画： SMovie_801

--注：脚本中所有跟时间相关的内容，皆可用小数，但最多精确到小数点后3位
-----------------------全局配置-----------------------
local GlobalConfig = {
	MovieName = "SMovie_801",
	LeadingActor = {
				},
...
local NpcTable = {
		...
		npc2 = {Basic = {id = 30201, name = "花妖", Occtime = 0.1, OccFrame = 1, Exttime = 5, ExitFrame = 3, posx = m_posx, posy = m_posy, dir = m_dir},
			},		
...
local TalkTable = {
	TalkList1 = {
		TalkData1 = {Npc = "npc2", Content = "咳咳咳，看来这几千年来没有动手，有点生疏了啊。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData2 = {Npc = "npc1", Content = "我记得我不是服用了安魂液吗，这不像是梦境啊，就算是幻觉也不应该如此清晰才对！这究竟是哪里？", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData3 = {Npc = "npc2", Content = "趁着这个人类在发呆，赶紧溜......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData4 = {Npc = "npc1", Content = "恩......#FACE<X:1,Y:4010000000>#", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData5 = {Npc = "npc1", Content = "跑，跑了？这花妖溜得还真是快啊......", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
		TalkData6 = {Npc = "npc1", Content = "下方好像有个木屋，催烟袅袅，应该是有人居住，去问问这到底是哪里吧。", ClickDelay = 3, NpcAction = {-1,-1}, NpcPop = "", NpcMove = {-1,-1}},
